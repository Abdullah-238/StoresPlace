...
@dso_cache = dso_local local_unnamed_addr global [1042 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 22497343, ; hash 0x157483f, from name: aot-SendGrid.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 98979476, ; hash 0x5e64e94, from name: aot-StoresPlace-Business
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 347869499, ; hash 0x14bc113b, from name: aot-StoresPlace-Front
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 466459232, ; hash 0x1bcd9a60, from name: aot-StoresPlace-DataAccess
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 568657566, ; hash 0x21e5069e, from name: StoresPlace-Business.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresPlace-Business.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 582041045, ; hash 0x22b13dd5, from name: libaot-StoresPlace-Business
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresPlace-Business.dll.so
		ptr null; void* handle (0x0)
	}, ; 130
	...
	%struct.DSOCacheEntry {
		i64 639912106, ; hash 0x262448aa, from name: StoresPlace-Business
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresPlace-Business.dll.so
		ptr null; void* handle (0x0)
	}, ; 148
	...
	%struct.DSOCacheEntry {
		i64 772754549, ; hash 0x2e0f4c75, from name: aot-StoresPlace-Front.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-StoresPlace-Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 174
	...
	%struct.DSOCacheEntry {
		i64 951394748, ; hash 0x38b521bc, from name: StoresPlace-DataAccess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StoresPlace-DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 209
	...
	%struct.DSOCacheEntry {
		i64 1201029973, ; hash 0x47964355, from name: StarkbankEcdsa
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1215846396, ; hash 0x487857fc, from name: StoresPlace-Front
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-StoresPlace-Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 265
	...
	%struct.DSOCacheEntry {
		i64 1234984150, ; hash 0x499c5cd6, from name: aot-SendGrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-SendGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 269
	...
	%struct.DSOCacheEntry {
		i64 1280027090, ; hash 0x4c4ba9d2, from name: libaot-StoresPlace-Business.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresPlace-Business.dll.so
		ptr null; void* handle (0x0)
	}, ; 282
	...
	%struct.DSOCacheEntry {
		i64 1444025158, ; hash 0x56121346, from name: libaot-StarkbankEcdsa
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.47_name, ; name: libaot-StarkbankEcdsa.dll.so
		ptr null; void* handle (0x0)
	}, ; 326
	...
	%struct.DSOCacheEntry {
		i64 1448030927, ; hash 0x564f32cf, from name: libaot-StoresPlace-Front.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-StoresPlace-Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 329
	...
	%struct.DSOCacheEntry {
		i64 1535937049, ; hash 0x5b8c8a19, from name: libaot-StoresPlace-Front
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-StoresPlace-Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 354
	...
	%struct.DSOCacheEntry {
		i64 1613085478, ; hash 0x6025bb26, from name: aot-StoresPlace-DataAccess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StoresPlace-DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 1630888696, ; hash 0x613562f8, from name: StoresPlace-Front.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-StoresPlace-Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 371
	...
	%struct.DSOCacheEntry {
		i64 2149868645, ; hash 0x80246465, from name: libaot-StarkbankEcdsa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.47_name, ; name: libaot-StarkbankEcdsa.dll.so
		ptr null; void* handle (0x0)
	}, ; 513
	...
	%struct.DSOCacheEntry {
		i64 2210798277, ; hash 0x83c61ac5, from name: SendGrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-SendGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 525
	...
	%struct.DSOCacheEntry {
		i64 2404934296, ; hash 0x8f586298, from name: aot-StarkbankEcdsa
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.47_name, ; name: libaot-StarkbankEcdsa.dll.so
		ptr null; void* handle (0x0)
	}, ; 577
	...
	%struct.DSOCacheEntry {
		i64 2495591052, ; hash 0x94bfb28c, from name: libaot-StoresPlace-DataAccess.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StoresPlace-DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 606
	...
	%struct.DSOCacheEntry {
		i64 2655526712, ; hash 0x9e481f38, from name: aot-StoresPlace-Business.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresPlace-Business.dll.so
		ptr null; void* handle (0x0)
	}, ; 643
	...
	%struct.DSOCacheEntry {
		i64 2893329082, ; hash 0xac74b2ba, from name: StoresPlace-DataAccess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StoresPlace-DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 704
	...
	%struct.DSOCacheEntry {
		i64 3112680087, ; hash 0xb987ba97, from name: aot-StarkbankEcdsa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.47_name, ; name: libaot-StarkbankEcdsa.dll.so
		ptr null; void* handle (0x0)
	}, ; 759
	...
	%struct.DSOCacheEntry {
		i64 3211913296, ; hash 0xbf71e850, from name: libaot-StoresPlace-DataAccess
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StoresPlace-DataAccess.dll.so
		ptr null; void* handle (0x0)
	}, ; 782
	...
	%struct.DSOCacheEntry {
		i64 3503176140, ; hash 0xd0ce39cc, from name: libaot-SendGrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-SendGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 846
	...
	%struct.DSOCacheEntry {
		i64 4166051015, ; hash 0xf850e4c7, from name: SendGrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-SendGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 1000
	...
	%struct.DSOCacheEntry {
		i64 4221931805, ; hash 0xfba5911d, from name: libaot-SendGrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-SendGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 1015
	...
	%struct.DSOCacheEntry {
		i64 4281174660, ; hash 0xff2d8a84, from name: StarkbankEcdsa.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.47_name, ; name: libaot-StarkbankEcdsa.dll.so
		ptr null; void* handle (0x0)
	}, ; 1032
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [214 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
